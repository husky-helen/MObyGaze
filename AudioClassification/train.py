...
def main(data_path, base_dir,train_folds, val_folds, test_folds):
    process_train.train_model_on_folds(data_path, base_dir, train_folds, val_folds, test_folds)
...
if __name__ == '__main__':
    ...
    for annotator in annotators:
        ...
        for el in data_path:
            main(el, feature_dir, train_folds, val_folds, test_folds)
