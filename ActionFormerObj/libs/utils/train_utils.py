...
def valid_one_epoch(
    ...
    if evaluator is not None:
        ...
        # call the evaluator
        _, mAP, _, results_logs = evaluator.evaluate(results, verbose=True)
    ...
    return losses, mAP, results_logs
...
def test_one_epoch(
    ...
    if evaluator is not None: #evaluator is det_eval
        if ext_score_file is not None and isinstance(ext_score_file, str):
